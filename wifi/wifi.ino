...
#define MY_SERVER_GET "192.168.1.227"
#define MY_SERVER_GET_URL ""
...
prog_char s_WT_HTML_HEAD_01[] PROGMEM = "HTTP/1.0 200 OK \r ";
...
prog_char s_WT_POST_HEAD_01[] PROGMEM = "HTTP/1.0\n";
...
{
  wifi.SendCommandSimple("set wlan auth 2","AOK");
  //WiFly.SendCommand("set wlan key <value>","AOK");
  wifi.SendCommandSimple("set wlan channel 0","AOK");
  wifi.SendCommandSimple("set wlan join 1","AOK");
  wifi.SendCommandSimple("set dhcp 1","AOK");
